...
AppId={{256E637C-712B-4FDD-9D2C-014D00740C8C}
AppName={#MyAppName}
...
OutputBaseFilename=Denning Student Portal
Compression=lzma
...
Source: "F:\dll files\mfplat.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\dll files\msvcp140.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\dll files\vcruntime140.dll"; DestDir: "{app}"; Flags: ignoreversion
