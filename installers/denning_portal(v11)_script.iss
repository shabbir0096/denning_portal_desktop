...
#define MyAppName "Denning Service Pvt ltd"
...
AppId={{F7EA9D65-988E-489A-BB7B-86FD07039249}
AppName={#MyAppName}
...
OutputBaseFilename=Denning_portal_setup(V4)
Compression=lzma
...
Source: "D:\Office Projects\denning_portal_updated_desktop\build\windows\runner\Release\api-ms-win-core-libraryloader-l1-2-0.dll"; DestDir: "{app}"; Flags: ignoreversion
